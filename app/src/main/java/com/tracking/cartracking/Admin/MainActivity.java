...
public class MainActivity extends AppCompatActivity {
   ...
   // private Toolbar toolbar;
    ...
    private void setupTabIcons() {
        ...
        tabLayout.getTabAt(3).getIcon().setColorFilter(getResources().getColor(R.color.gray), PorterDuff.Mode.SRC_IN);
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                    ...
                    else if(tab.getPosition()==2){ title.setText(getResources().getString(R.string.Arrival_and_departure));}
                    else if(tab.getPosition()==3){ title.setText(getResources().getString(R.string.employees));}
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new TasksFragment(),getResources().getString(R.string.tasks));
        adapter.addFragment(new RegistryFragment(), getResources().getString(R.string.Registry));
        adapter.addFragment(new EmployeesFragment(), getResources().getString(R.string.employees));
